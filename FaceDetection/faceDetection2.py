...
# python faceDetection2.py --face Cascades/haarcascade_frontalface_default.xml --image Images/obama.png --output Output/detection1.jpg
...
ap.add_argument("-o", "--output", required = True,
	help = "Path to where the output image will be stored")
